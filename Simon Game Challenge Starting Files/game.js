//I want to create a responsive game. In that game the user can click on four buttons in different colors("green, red, yellow and blue")
//the game starts when the user presses a key on the keyboard;
//lets make the start of the game;
